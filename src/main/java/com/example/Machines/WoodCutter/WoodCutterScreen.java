...
public class WoodCutterScreen extends ContainerScreen<WoodCutterContainer> {
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(CryIndustry.MOD_ID, "textures/gui/woodcutter_gui.png");

    public WoodCutterScreen(WoodCutterContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
