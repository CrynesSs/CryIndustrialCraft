...
import com.example.MultiBlockStructure.ReactorStructure.ReactorTE;
...
public class TileEntityTypes {
    ...
    public static final RegistryObject<TileEntityType<ReactorTE>> REACTOR = TILE_ENTITY_TYPES.register("reactor", () -> TileEntityType.Builder.of(ReactorTE::new, BlockInit.REACTOR_FRAME.get()).build(null));
